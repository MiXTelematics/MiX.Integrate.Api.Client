  ...
  public interface IFuelClient : IBaseClient
	{
	  ...
	  IList<FuelTransaction> GetFuelByDateRangeForGroup(long organisationId, DateTime from, DateTime to);
		Task<IList<int>> AddFuelTransactionsForGroupAsync(long organisationId, IList<FuelTransaction> transactions);
		IList<int> AddFuelTransactionsForGroup(long organisationId, IList<FuelTransaction> transactions);
	}
}
